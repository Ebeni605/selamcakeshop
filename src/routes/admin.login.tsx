...
const MANAGER_PASSWORD = "SelamManager2026!";
...
function AdminLogin() {
  ...
  const [pw, setPw] = useState(MANAGER_PASSWORD);
  ...
  function switchMode(m: Mode) {
    ...
    setErr("");
    setOk("");
    setPw(m === "change" ? "" : MANAGER_PASSWORD);
    setNewPw("");
    setConfirmPw("");
  }
          ...
          <div className="auth-group">
            ...
            <div className="auth-input">
              ...
              <input
                ...
                placeholder="manager@selamcake.com"
          ...
          <div className="auth-group">
            ...
            <div className="auth-input">
              ...
              <input
                ...
                placeholder="Use SelamManager2026!"
